        ...
        <form method="post" action="{{ route('LaravelInstaller::licenseCheck') }}" class="tabs-wrap">
            ...
            <div>
                <div class="form-group {{ $errors->has('email') ? ' has-error ' : '' }}">
                    ...
                    <p>Nulled By <a href="https://nulljungle.com">NullJungle.com</a></p>
                    @if ($errors->has('email'))
                ...
                <div class="form-group {{ $errors->has('username') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="username" id="username"  placeholder="Username of Your Envato Account" value="NullJungle.com" />
                ...
                <div class="form-group {{ $errors->has('purchase_code') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="purchase_code" id="purchase_code" placeholder="Your Item Purchase Code" value="NullJungle.com" />
